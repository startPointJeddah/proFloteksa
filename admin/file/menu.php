...
<?php
  ...
  if(  $userview4_u == 'on' ){
      ?>
      <li class="<?php if(basename($_SERVER['PHP_SELF'])=='settings.php'){echo 'active';}else{ echo '';}?>"><a href="groups.php"> <i class="fa fa-object-group"></i> <span>المجموعات</span> <span class="pull-right-container"> </span> </a> </li>
          <?php
  }
  ?>
