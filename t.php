                ...
                <div class="box box-primary">
                    <div class="box-header  with-border">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            if ( isset($_POST['submit'])) if ( isset($_FILES['uploadFile']['name']) && $_FILES['uploadFile']['name'] != "" ) {
...
// Read a row of data into an array
                                            ...
                                            $floor=$rowData[0][2];
                                            $flat=$rowData[0][3];
                                            $stock=$rowData[0][4];  // stockقطعه
                                            $adress=$rowData[0][5];
                                            $bulding=$rowData[0][6]; //buliding
                                            $project=$rowData[0][7];
                                            $salesName=$rowData[0][8];
                                            $status=$rowData[0][9];
...
<!-- /.content-wrapper -->         <?php include ('file/footer.php');?>
