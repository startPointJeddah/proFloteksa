    ...
    <section class="content"> 
      ...
      <div class="row"> 
       ...
       <div class="box-header with-border">
                   ...
                   <a href="Upload/Templat/العملاء.xlsx" download="العملاء"><i class="fa fa-file-excel-o"></i> Template</a>
...
if ( $name != '' || $project !='' ){
  mysqli_query($conn,"insert into customers (token,whatssapp,name,phone,mobile,mail,adress,project,bulding,stock,flat,floor) values ('$token','$whatssapp','$name','$phone','$mobile','$mail','$adress','$project','$bulding','$stock','$flat','$floor')");
}
if ( $name == '' || $project =='' ){
