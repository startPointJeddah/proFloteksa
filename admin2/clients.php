...
<th>العنوان </th>				
    <th>المشروع </th>		 	
      ...
      <td class="text-center">
						<a title="المراحل"  href='#' class="btn btn-primary" data-toggle="modal" data-target="#addimg<?php echo $row["id"]; ?>">
						<i class="fa fa-plus"></i></span> الصور</a>
					</td>
					  <td class="text-center">
						<a title="المراحل"  href='#' class="btn btn-success" data-toggle="modal" data-target="#step<?php echo $row["id"]; ?>">
						<i class="fa fa-edit"></i></span> المراحل</a>
					</td>
                    <td>
                    <?php echo $row['phone']; ?>
                    </td>
          ...
          <td>
          <a target="_blank" href="https://api.whatsapp.com/send?phone=00966<?php echo $row['whatssapp']; ?>&text=http://localhost/project/?c=<?php echo $row['token']; ?>&app_absent=0"> <?php echo $row['whatssapp']; ?></a>
                ...
                <div class="modal-content">
                    ...
                    <form action="" method="post" >
                     <input type="hidden" name="id" value="<?php echo $row["id"]; ?>"   class="form-control" >
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">تراجع</button>
                            <button type="submit" name="updatem" class="btn btn-primary">حفظ</button>
                        </div>
                    </form>
        ...
        <div class="modal fade" id="addimg<?php echo $row["id"]; ?>"  role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <input type="hidden" name="imgold" value="<?php echo $row["img"]; ?>"   class="form-control" >
                        ...
                        <div class="modal-body">
                            ...
                            <br>
                             ...
                             <select style="width: 100% auto" class="form-control select2"  name="imgetype"   required>
            ...
            $sql_image="select * from imgs where cid = '$row[id]' ";
               ...
               while($row_imge = $result_imge->fetch_assoc()) {
                ...
                <span><?php if ($row_imge['imgetype'] == '1'){
                    echo 'صور الإنشاءات';
